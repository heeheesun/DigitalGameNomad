...
public class CompanyDTO {
    ...
    public CompanyDTO(Long company_key, String company_name, @Nullable String company_text, @Nullable String game_name, @Nullable String game_url, String company_date, Integer company_pass, @Nullable String youtube_url) {
    ...
    public Companyinfo toEntity(){
        return new Companyinfo(company_key,company_name,company_text,game_name,game_url,company_date ,company_pass,null,youtube_url);
   }
