      ...
      <div className="i__article">
        ...
        <ul className="i__ul1">
          <li className="i__li1">
            ...
            <p className="i__p2">부스예약</p>
            <p className="i__p3">간편하게 부스예약 해드립니다.</p>
          </li>
          <li className="i__li1">
          ...
          <li className="i__li1">
            ...
            <p className="i__p2">전시관 일정 알림</p>
            <p className="i__p3">게임 전시 일정을 확인할 수 있습니다.</p>
          </li>
        </ul>
        <ul className="i__ul2">
          <li className="i__li2">
