...
const PhonenumberChange = () => {
    ...
    const [loginUserKey, setLoginUserKey] = useState(null);
    ...
    const saveData = () => {
        ...
        const URL = "http://49.50.174.251:8088/updateUser";
            const postData = {
    ...
    useEffect(()=>{
        if(user) {
            setLoginUserKey(user.loginUserKey);
    ...
    const registerRegExCheck = (regEx, value) => {
        ...
        return (
            <div className='phonenumberchange'>
                ...
                <div>
                    <label className="phonenumberchange-text">핸드폰 번호 입력</label>
                    {phoneNumber}
                    
                </div>

                <div>
                    <label className="phonenumberchange-text">변경된 번호 입력</label>
                ...
                <button className='phonenumberchange-button'onClick={handleGoBack}>취소</button>
                <button className='phonenumberchange-button'onClick={saveData}>확인</button>
