        ...
        columns: [
          {
            Header: "별점",
            accessor: (item) => {
              if (item.post_score == 20) return "★☆☆☆☆";
              else if (item.post_score == 40) return "★★☆☆☆";
              else if (item.post_score == 60) return "★★★☆☆";
              else if (item.post_score == 80) return "★★★★☆";
              else if (item.post_score == 100) return "★★★★★";
              return "";
            },
          },
        ],
