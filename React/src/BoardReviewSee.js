...
const BoardSee = (props) => {
  ...
  useEffect(() => {
    ...
    let board_2 = board_1.find((e) => e.postKey == num);
    //const URL = "http://localhost:8088/boardCount";
    const URL = "http://49.50.174.251:8088/boardCount";
    const postData = {
  ...
  const deleteBoard = () => {
    //const URL = "http://localhost:8088/deleteBoard";
    const URL = "http://49.50.174.251:8088/deleteBoard";
    const postData = {
      postKey: postKey,
      image_url: image_url,
    };
  ...
  return (
    <div>
      ...
      <div className="see-frame">
          <div className="main-user">&#91; 작성자	&#93; {user_id}</div>
