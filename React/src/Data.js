...
const Data = () => {
    ...
    if(board[0] === "re" || comment[0] === "re" || company[0] === "re") {
        if(board[0] === "re") {
            ...
            let url = "http://49.50.174.251:8088/boardshow"; //backend의 데이터 불러오기
        ...
        if(comment[0] === "re") {
            //let url = "http://localhost:8088/allcomments"; //backend의 데이터 불러오기
            let url = "http://49.50.174.251:8088/allcomments"; //backend의 데이터 불러오기
        ...
        if(company[0] === "re") {
            //let url = "http://localhost:8088/allcompany"; //backend의 데이터 불러오기
            let url = "http://49.50.174.251:8088/allcompany"; //backend의 데이터 불러오기
